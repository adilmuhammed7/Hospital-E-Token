...
if(isset($_POST['sbmt'])){
	...
	$query = mysqli_query ($a,"SELECT * FROM login_table WHERE username = '$user' AND password = '$pass'");
	...
	if($data['type']=='docter'){
		...
		header('location:docter home.php');
	}
				...
				<div class="col-lg-6">
					<div class="text-lg-right top-right-bar mt-2 mt-lg-0">
						<a href="tel:+23-345-67890" >
							<span>Call Now : </span>
							<span class="h4">00000000000</span>
						</a>
					</div>
				</div>
			</div>
				...
				<div class="feature-block d-lg-flex">
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<ul class="w-hours list-unstyled">
		                    <li class="d-flex justify-content-between"><span><input name = "us" type="text" class="form-control" placeholder="Your username">
		                    <li class="d-flex justify-content-between"><span><input name = "ps" type="text" class="form-control" placeholder="Your password"><br>
                            <div class="col-lg-6">
                            ...
                            <!-- <a href="Hospital E Token/" class="btn btn-main btn-round-full">Login</a><br><br> -->
							<button name = "sbmt" class="btn btn-main btn-round-full">Login</button>
