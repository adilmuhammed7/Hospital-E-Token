			   ...
			   <li class="nav-item"><a class="nav-link" href="about.html">About</a></li>
			    ...
			    <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown02">
						<li><a class="dropdown-item" href="docter signup.php">Docter</a></li>
						<li><a class="dropdown-item" href="patient signup.php">Patient</a></li>
						<li><a class="dropdown-item" href="pharmacy signup.php">pharmacy</a></li>
					</ul>
			  	</li>
			...
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					...
					<div class="btn-container ">
						<a href="login.php" target="_blank" class="btn btn-main-2 btn-icon btn-round-full">LOGIN<i class="icofont-simple-right ml-2  "></i></a>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<h4 class="mb-3">Online Appoinment</h4><br>
