			  ...
			  <li class="nav-item active">
			   ...
			   <li class="nav-item"><a class="nav-link" href="about.html">About</a></li>
			    ...
			    <li class="nav-item dropdown">
					<a class="nav-link dropdown-toggle" href="department.html" id="dropdown02" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Medicine<i class="icofont-thin-down"></i></a>
					<ul class="dropdown-menu" aria-labelledby="dropdown02">
						<li><a class="dropdown-item" href="add medicine.php">Add Medicine</a></li>
                        <li><a class="dropdown-item" href="pharmacy view medicine.php">View Medicine</a></li>
			   ...
			   <li class="nav-item dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="dropdown05">
						<!-- <li><a class="dropdown-item" href="blog-sidebar.html"></a></li> -->

						<li><a class="dropdown-item" href="pharmacy feedback view.php">View Feedback</a></li>
					</ul>
			  	</li>
			...
			<div class="col-lg-12">
				<div class="feature-block d-lg-flex">
					<div class="feature-item mb-5 mb-lg-0">
						...
						<a href="appoinment.html" class="btn btn-main btn-round-full">Chat With Patient</a>
					</div>
